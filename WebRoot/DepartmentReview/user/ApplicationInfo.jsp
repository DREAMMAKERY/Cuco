...
<td><a href="<c:url value='/ApplicationServlet?method=setDepartmentVerifyResult&id=${application.id }'/>">审核通过</a>&nbsp;&nbsp;
<a href="<c:url value='/ApplicationServlet?method=setDepartmentVerifyResultFail&id=${application.id }'/>">审核失败</a>&nbsp;&nbsp;</td>
<td></td> 
</c:forEach>
