...
var bar1 = new Q6MenuBar("bar1", "学生资助申请-院系审核");
function load() {
	...
	body：结果的显示框架页名称
	*/
	bar1.add("院系审核", "审核学生资助申请", "<c:url value='/ApplicationServlet?method=findByClassVerfiy'/>", "body");
	bar1.add("院系审核", "下载评审名单", "<c:url value='/MemberListServlet?method=findAll'/>", "body");
	

	bar1.add("贫困认定办法公布", "查看公布", "<c:url value='/ClassReview/user/public.html'/>", "body");
	bar1.add("资助学生名单发布", "名单发布", "<c:url value='/ApplicationServlet?method=findByDepartmentVerfiy'/>", "body");
